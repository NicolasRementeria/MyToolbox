            ...
            while True:
                ...
                # History
                    ...
                    for msg in reversed(messages):
                        ...
                        #csvstring = ""
                        #fullmessage = "Hour="+str(msg.date.hour) + ", Min="+str(msg.date.minute) + ", ID="+str(msg.id)+", NAME="#+name + ", CONTENT=" + str(msg.message)
                        #csvstring += fullmessage
                        #    writer = csv.writer(file)
                        #    writer.writerow([msg.date.hour, msg.date.minute, msg.id, name, content])
                    #with open("Output.txt", "w") as text_file:
                    #    text_file.write(csvstring)
                    #sprint(csvstring,  file=open('.\Output.txt', 'a'))
...
if __name__ == '__main__':
    ...
    #API_ID = "hardcoded API ID"
    #API_HASH = "hardcoded API HASH"
